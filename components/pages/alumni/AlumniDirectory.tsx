    ...
    <section className="py-32 relative">
      ...
      <motion.div
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 2xl:gap-24">
            {alumniProfiles.map((profile, index) => (
              <motion.div
                ...
                <Card className="group hover:shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300 overflow-hidden backdrop-blur-xl bg-background/40 border-primary/10 2xl:w-[440px]">
                    ...
                    <div className="relative flex items-start gap-6">
                      ...
                      <div className="space-y-2.5">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          <span
                            className="px-3 py-1 rounded-full bg-primary/10 text-foreground font-medium"
                            title={`Class of ${profile.graduation}`}>
                            {profile.graduation}
                          </span>
